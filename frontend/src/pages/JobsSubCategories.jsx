...
import { FaArrowLeft, FaCode, FaPalette, FaServer, FaLaptopCode, FaMobileAlt, FaRobot, FaChartBar, FaGamepad } from 'react-icons/fa';
...
const SUBCATEGORIES = {
  'it-software': [
    ...
    { id: 'software-engineering', name: 'Software Engineering', icon: FaLaptopCode, color: 'from-teal-400 to-teal-600' },
    { id: 'game-development', name: 'Game Development', icon: FaGamepad, color: 'from-red-400 to-red-600' },
  ],
  'medical': [
    { id: 'mbbs', name: 'MBBS Doctors', icon: FaCode, color: 'from-red-400 to-red-600' },
    { id: 'bds', name: 'BDS Dentists', icon: FaPalette, color: 'from-pink-400 to-pink-600' },
    ...
    { id: 'radiology', name: 'Radiology', icon: FaChartBar, color: 'from-orange-400 to-orange-600' },
  ],
  'banking-management': [
    ...
    { id: 'operations', name: 'Operations', icon: FaRobot, color: 'from-purple-400 to-purple-600' },
  ],
  'marketing-sales': [
    ...
    { id: 'business-development', name: 'Business Development', icon: FaRobot, color: 'from-indigo-400 to-indigo-600' },
  ],
  'database-devops': [
    ...
    { id: 'network', name: 'Network Engineer', icon: FaMobileAlt, color: 'from-orange-400 to-orange-600' },
  ],
};
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 py-12">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-neutral-600 dark:text-neutral-400 mb-10 text-lg">
          Select a specialization to view job opportunities
        </p>
...
export default JobsSubCategories;
