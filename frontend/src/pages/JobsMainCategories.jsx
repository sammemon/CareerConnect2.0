...
const MAIN_CATEGORIES = [
  { 
    ...
    description: 'Tech jobs in software development, AI, data science, and more'
  },
  { 
    id: 'medical', 
    ...
    description: 'Medical professionals, healthcare, and pharmaceutical roles'
  },
  { 
    ...
    description: 'Banking, finance, management, and HR positions'
  },
  { 
    id: 'marketing-sales', 
    ...
    description: 'Marketing, sales, digital marketing, and business development'
  },
  { 
    id: 'database-devops', 
    ...
    description: 'Database administration, DevOps, cloud, and infrastructure'
  },
  { 
    id: 'all', 
    name: 'All Fields', 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {MAIN_CATEGORIES.map((cat) => {
            ...
            return (
              <Link
                key={cat.id}
                to={cat.id === 'all' ? '/jobs' : `/jobs-categories/${cat.id}`}
...
export default JobsMainCategories;
